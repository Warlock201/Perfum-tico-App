...
old_list_forEach = """
                            listOf("Já possuo", "Decant", "Quero ter", "Desejo", "Nenhum").forEach { st ->
"""
...
old_colors = """
                                        selectedContainerColor = if (st == "Já possuo") Amber400 else if (st == "Decant") Emerald400 else if (st == "Quero ter") Cyan500 else if (st == "Desejo") Purple500 else Slate700,
"""
new_colors = """
